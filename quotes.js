const quotes = [
    ...
    {
     quote: "If you can not fly then run. If you cannot run, then walk. but whatever you do, you have to keep moving forward",
     author:"Martin Luther King Jr.",},
    {
     quote: "Our greatest weakness lies in giving up. the most certain wqy to succeed is always to try just one more time.",
